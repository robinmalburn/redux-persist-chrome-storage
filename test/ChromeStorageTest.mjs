...
import ChromeStorage from "../src/storage/ChromeStorage.mjs";
...
describe("ChromeStorage", function () {
  ["sync", "local", "managed"].forEach(function (driver) {
    ...
    it(`should set an item in the ${driver} storage instance.`, async function () {
      ...
      chai.expect(stored).to.eventually.be.undefined;
    });

    it(`should handle failing to set an item in the ${driver} storage instance.`, async function () {
